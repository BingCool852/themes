...
function cosimo_scripts() {
	...
	wp_enqueue_style( 'cosimo-googlefonts-heading', $protocol .'://fonts.googleapis.com/css?family=Oswald:400,700');
	wp_enqueue_style( 'cosimo-googlefonts-text', $protocol .'://fonts.googleapis.com/css?family=Roboto:400,700');
