	...
	<div class="content-cosimo">
			<?php
				if ( '' != get_the_post_thumbnail() ) {
					echo '<div class="entry-featuredImg cosimo-loader"><a href="' .get_permalink(). '">';
						if ($i == 0 && $masonryBig == 1 ) {
			...
			<footer class="entry-footer smallPart">
				<?php edit_post_link( esc_html__( '编辑', 'cosimo' ), '<span class="edit-link floatLeft"><i class="fa fa-wrench spaceRight"></i>', '</span>' ); ?>
